...
static void vc_isr_error_checking(struct vcap_dev *dev,
...
static bool vc_isr_verify_expect_buf_rdy(struct vcap_dev *dev,
...
static void vc_isr_update_timestamp(struct vcap_dev *dev,
...
static void vc_isr_no_new_buffer(struct vcap_dev *dev,
		struct vcap_client_data *c_data, struct v4l2_event v4l2_evt)
{
	v4l2_evt.type = V4L2_EVENT_PRIVATE_START +
